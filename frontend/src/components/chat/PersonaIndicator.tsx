...
const PersonaIndicator: React.FC<PersonaIndicatorProps> = ({
  activePersonas,
  ...
  const getPersonaColor = (role: string) => {
    ...
    return colors[role as keyof typeof colors] || 'bg-gray-500 border-gray-200';
  };
    ...
    >
      ...
      {activePersonas.length > 0 && (
        <div className="mt-2 flex flex-wrap gap-1">
          {activePersonas.flatMap((persona) =>
